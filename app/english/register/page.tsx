...
const STUDENT_PURPOSES: {
...
}[] = [
  {
    ...
    icon: '🧾',
    title: 'Accounting',
    desc: 'Бухгалтерия, отчётность, налоги и деловая документация.',
  },
  {
    value: 'computer_science',
    icon: '💻',
    title: 'Computer Science',
    desc: 'IT-лексика, документация, техническая коммуникация.',
  },
  {
    value: 'hospitality',
    icon: '🏨',
    title: 'Hospitality',
    desc: 'Английский для сервиса, туризма и работы с клиентами.',
  },
  {
    value: 'management',
    icon: '📊',
    title: 'Management',
    desc: 'Управление, деловая речь, рабочие встречи и лидерство.',
  },
  {
    value: 'finance_industry',
    icon: '💰',
    title: 'Finance Industry',
    desc: 'Финансы, рынки, отчёты и профильная терминология.',
  },
  {
    value: 'social_sciences',
    icon: '🧠',
    title: 'Social Sciences',
    desc: 'Гуманитарные дисциплины и академическая коммуникация.',
  },
  {
    value: 'law',
    icon: '⚖️',
    title: 'Law',
    desc: 'Юридическая лексика, formal English и документы.',
  },
]
...
export default function EnglishRegisterPage() {
  ...
  const [studentPurpose, setStudentPurpose] =
    useState<StudentPurpose>('accounting')
  ...
  async function handleRegister(e: React.FormEvent) {
    ...
    try {
      ...
      if (data.user) {
        await supabase.from('english_user_roles').insert({
  ...
  return (
    <div className="register-page">
        ...
        <div className="register-layout">
          <aside className="left-panel">
            ...
            <h1 className="hero-title">
              Создайте аккаунт
              <br />
              <span>и начните правильно</span>
            </h1>

            <p className="hero-text">
              Студент выбирает направление перед входом в платформу. Преподаватель
              просто создаёт аккаунт без лишних шагов.
            </p>
            ...
            <div className="feature-list">
              <div className="feature-item">
                ...
                <div>
                  <div className="feature-title">Для студентов</div>
                  <div className="feature-text">
                    Выбор направления ещё до входа в платформу.
                  </div>
                </div>
              </div>
              ...
              <div className="feature-item">
                <div className="feature-icon">👩‍🏫</div>
                <div>
                  <div className="feature-title">Для преподавателей</div>
                  <div className="feature-text">
                    Без purpose и без лишней логики.
                  </div>
                </div>
              </div>
              ...
              <div className="feature-item">
                <div className="feature-icon">🔐</div>
                <div>
                  <div className="feature-title">После регистрации</div>
                  <div className="feature-text">
                    Сразу переход на страницу логина.
                  </div>
                </div>
              </div>
            </div>
            ...
            <form onSubmit={handleRegister} className="form-stack">
                ...
                <div className="role-grid">
                  ...
                  >
                    ...
                    <div className="role-text">
                      Для обучения и прохождения направлений
                    </div>
                  </button>
                  ...
                  >
                    <div className="role-icon">👩‍🏫</div>
                    <div className="role-title">Преподаватель</div>
                    <div className="role-text">
                      Для работы с учениками и обучением
                    </div>
                  </button>
                </div>
              </div>
                ...
                <div>
                  ...
                  <div className="purpose-grid">
                    {STUDENT_PURPOSES.map((item) => {
                      const isActive = studentPurpose === item.value
              ...
              <div>
                ...
                <div className="field-hint">
                  После регистрации вы перейдёте на страницу логина.
                </div>
              </div>
              ...
              <div className="cta-block">
                <div className="cta-copy">
                  ...
                  <div className="cta-text">
                    {role === 'student'
                      ? 'После регистрации студент попадёт на логин, а затем уже в платформу.'
                      : 'После регистрации преподаватель попадёт на логин, а затем в свой кабинет.'}
                  </div>
                </div>
              ...
              <div className="login-row">
                ...
                <button
                  type="button"
                  onClick={() => router.push('/english/login')}
                >
                  Войти
                </button>
              </div>
      ...
      <style>{`
        ...
        .purpose-card.active {
          border: 2px solid #0ea5e9;
          background: linear-gradient(135deg, rgba(56,189,248,0.10), rgba(255,255,255,0.94));
