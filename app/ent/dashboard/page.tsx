  ...
  return (
    <div>
      ...
      >
        ...
        <div className="dash-hero-grid" style={{ display: 'grid', gridTemplateColumns: '1.2fr 0.8fr', gap: 28, alignItems: 'center', position: 'relative', zIndex: 1 }}>
          <div>
            ...
            <div style={{ display: 'flex', gap: 12, flexWrap: 'wrap' }}>
              ...
              <motion.a
                href="/ent/dashboard/ai-analysis"
          ...
          <div style={{ background: 'rgba(255,255,255,0.08)', border: '1px solid rgba(255,255,255,0.10)', borderRadius: 24, padding: 22, backdropFilter: 'blur(14px)' }}>
            ...
            {studyPlans.length === 0 ? (
              <div style={{ color: 'rgba(255,255,255,0.65)', fontSize: 14, lineHeight: 1.7 }}>
                ...
                <a href="/ent/dashboard/study-plan" style={{ color: '#38bdf8', fontWeight: 800 }}>Жасау →</a>
              </div>
            ) : (
      ...
      {/* Metrics row */}
      <div className="dash-metrics-grid" style={{ display: 'grid', gridTemplateColumns: 'repeat(4, 1fr)', gap: 16, marginBottom: 20 }}>
        {[
      ...
      {/* Content grid */}
      <div className="dash-content-grid" style={{ display: 'grid', gridTemplateColumns: '1.15fr 0.85fr', gap: 18, marginBottom: 18 }}>
        {/* Progress chart */}
        <motion.div
          initial={{ opacity: 0, y: 18 }}
          animate={{ opacity: 1, y: 0 }}
        ...
        >
          <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-start', marginBottom: 20 }}>
            ...
            <a href="/ent/dashboard/progress" style={{ textDecoration: 'none', padding: '10px 16px', borderRadius: 14, border: '1px solid rgba(14,165,233,0.15)', background: '#f8fafc', color: '#0c4a6e', fontSize: 13, fontWeight: 800 }}>
              Толық →
            </a>
          </div>
      ...
      {/* Bottom summary */}
      <div className="dash-bottom-grid" style={{ display: 'grid', gridTemplateColumns: '1.2fr 0.9fr 0.9fr', gap: 18 }}>
        {[
          {
            label: 'Оқушы профилі',
            content: (
