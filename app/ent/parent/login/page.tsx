  ...
  const handleLogin = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (profile.role !== 'parent') {
        alert('Бұл аккаунт ата-ана емес')
        await supabase.auth.signOut()
        return
      }

      window.location.href = '/ent/dashboard/parent'
    } finally {
      setLoading(false)
    }
  }
    ...
    >
      ...
      >
        ...
        >
          ...
          >
            Балаңыздың прогресін және нәтижесін көру үшін кіріңіз.
          </p>
          ...
          >
            ...
            <button type="submit" style={primaryButton(!canLogin || loading)}>
              {loading ? 'Кіріп жатыр...' : 'Ата-ана ретінде кіру'}
            </button>
          </form>
